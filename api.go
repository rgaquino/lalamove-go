...
func (c *Client) OrderDetails(ctx context.Context, region UNLOCODE, req *OrderDetailsRequest) (*OrderDetailsResponse, error) {
...
func (c *Client) CancelOrder(ctx context.Context, region UNLOCODE, req *CancelOrderRequest) (*CancelOrderResponse, error) {
...
func (c *Client) DriverDetails(ctx context.Context, region UNLOCODE, req *DriverDetailsRequest) (*DriverDetailsResponse, error) {
...
func (c *Client) DriverLocation(ctx context.Context, region UNLOCODE, req *DriverLocationRequest) (*DriverLocationResponse, error) {
